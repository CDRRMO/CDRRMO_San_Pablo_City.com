...
?>
  <div class="heading" style="text-align:center;margin:20px 0">ADD MAPPING</div>
      <script type="text/javascript" src="https://maps.googleapis.com/maps/api/js?language=en&key=AIzaSyAeji5o5yGuXQNLLJmuogHbbuRGXmeNXUY"></script>
      <div id="map"></div>
...
<script>
        ...
        var myOptions = {
            zoom: 12,
            center: new google.maps.LatLng(14.0642, 121.3233),
            mapTypeId: 'roadmap'
        };
        ...
        function saveData(lat,lng) {
            ...
            var url = 'map/locations_model.php?add_location&description=' + description + '&lat=' + lat + '&lng=' + lng;
